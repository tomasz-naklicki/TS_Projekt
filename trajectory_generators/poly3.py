...
class Poly3(TrajectoryGenerator):
    ...
    def generate(self, t):
        ...
        q_dot = -3 * self.a_0 + self.a_1 + 2 * t * (3 * self.a_0 - 2 * self.a_1 + self.a_2) + 3 * t ** 2 * (-self.a_0 + self.a_1 - self.a_2 + self.a_3)
        q_ddot = 2 * (3 * self.a_0 - 2 * self.a_1 + self.a_2) + 6 * t * (-self.a_0 + self.a_1 - self.a_2 + self.a_3)
